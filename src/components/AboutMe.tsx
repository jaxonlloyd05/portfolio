...
const AboutMe: React.FC = () => {
  ...
  return (
    <div id='aboutme' className='pb-12'>
        ...
        <div className='hero-content justify-between items-start w-full flex-col lg:flex-row-reverse'>
          ...
          <div className='flex flex-col gap-4'>
            <p className='text-sm'>
              ...
              understanding how it all works has been a lifelong passion. So far, this curiosity has led me to move far away from home to study and work with some brilliant people and
              I'm excited to see where this passion takes me next!
            </p>

            <ul className='grid grid-cols-3 gap-1 text-xs'>
              <li><FaJs size={24} /></li>
              <li><FaReact size={24} /></li>
              <li><FaPython size={24} /></li>
              <li>...</li>
              <li>...</li>
              <li>...</li>
              <li>...</li>
